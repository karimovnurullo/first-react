...
import "./pricing.scss";
import pricingImg1 from "./img1.png";
import pricingImg2 from "./img2.png";
import pricingImg3 from "./img3.png";
      ...
      <div className="pricing" id="pricing">
        ...
        <div className="pricing-box">
          <div className="box">
            ...
            <p>Start learning English online in live classes with qualified EC teachers.</p>
            <div className="price">
              <h4> £5.99</h4>
              <p> per month</p>
            </div>
